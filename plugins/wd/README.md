...
`wd` comes bundled with [oh-my-zshell](https://github.com/xqzhang2015/oh-my-zsh)!
...
If you're NOT using [oh-my-zsh](https://github.com/xqzhang2015/oh-my-zsh) and you want to utilize the zsh-completion feature, you will also need to add the path to your `wd` installation (`~/bin/wd` if you used the automatic installer) to your `fpath`. E.g. in your `~/.zshrc`:
 ...
 * You can warp back to previous directory, and so on, with this dot syntax:
    ...
    (You might need `setopt AUTO_PUSHD` in your `.zshrc` if you hare not using [oh-my-zshell](https://github.com/xqzhang2015/oh-my-zsh)).
